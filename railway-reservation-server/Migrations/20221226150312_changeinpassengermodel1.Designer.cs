...
namespace railwayReservation.Migrations
{
    ...
    [Migration("20221226150312_changeinpassengermodel1")]
    partial class changeinpassengermodel1
    {
            ...
            modelBuilder.Entity("railwayReservation.Models.Tickets", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            journeyDate = new DateTime(2022, 12, 26, 20, 33, 11, 433, DateTimeKind.Local).AddTicks(6541),
                            ticketFare = 580,
