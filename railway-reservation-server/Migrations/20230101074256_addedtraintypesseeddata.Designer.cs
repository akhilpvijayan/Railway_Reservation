...
namespace railwayReservation.Migrations
{
    ...
    [Migration("20230101074256_addedtraintypesseeddata")]
    partial class addedtraintypesseeddata
    {
            ...
            modelBuilder.Entity("railwayReservation.Models.Tickets", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            journeyDate = new DateTime(2023, 1, 1, 13, 12, 55, 598, DateTimeKind.Local).AddTicks(1966),
                            ticketFare = 580,
